...
const routes: Routes = [
  ...
  { path: 'dr/dashboard', component: DrDashboardComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/new-appointment', component: DrNewAppointmentComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/patient-info/:patientId', component: DrPatientInfoComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/appointment/patient-qr', component: DrNewAppointmentQRComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/appointment/:patientId', component: DrNewAppointmentComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/prescription/patient-qr/:patientId', component: DrNewPrescriptionQRComponent, canActivate: [AuthGuardService]  },
  { path: 'dr/prescription/:patientId', component: DrCreatePrescriptionComponent , canActivate: [AuthGuardService] },
  ...
  { path: 'patient/appointments-detail', component: AppointmentsDetailComponent, canActivate: [AuthGuardService]  },
  { path: 'patient/history-detail', component: HistoryDetailComponent, canActivate: [AuthGuardService]  },
  { path: 'patient/prescriptions-detail', component: PrescriptionsDetailComponent , canActivate: [AuthGuardService] },
